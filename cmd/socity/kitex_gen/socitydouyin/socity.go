...
type CommentActionResponse struct {
	StatusCode int32         `thrift:"status_code,1" frugal:"1,default,i32" json:"status_code"`
	StatusMsg  *string       `thrift:"status_msg,2,optional" frugal:"2,optional,string" json:"status_msg,omitempty"`
	Comment    *base.Comment `thrift:"comment,3,optional" frugal:"3,optional,base.Comment" json:"comment,omitempty"`
}
...
func (p *CommentActionResponse) Field3DeepEqual(src *base.Comment) bool {
...
type SocityServiceClient struct {
	c thrift.TClient
}

func NewSocityServiceClientFactory(t thrift.TTransport, f thrift.TProtocolFactory) *SocityServiceClient {
	return &SocityServiceClient{
		c: thrift.NewTStandardClient(f.GetProtocol(t), f.GetProtocol(t)),
	}
}

func NewSocityServiceClientProtocol(t thrift.TTransport, iprot thrift.TProtocol, oprot thrift.TProtocol) *SocityServiceClient {
	return &SocityServiceClient{
		c: thrift.NewTStandardClient(iprot, oprot),
	}
}

func NewSocityServiceClient(c thrift.TClient) *SocityServiceClient {
	return &SocityServiceClient{
		c: c,
	}
}

func (p *SocityServiceClient) Client_() thrift.TClient {
	return p.c
}

func (p *SocityServiceClient) FavoriteAction(ctx context.Context, req *FavoriteActionRequest) (r *FavoriteActionResponse, err error) {
	var _args SocityServiceFavoriteActionArgs
	_args.Req = req
	var _result SocityServiceFavoriteActionResult
	if err = p.Client_().Call(ctx, "FavoriteAction", &_args, &_result); err != nil {
		return
	}
	return _result.GetSuccess(), nil
}
func (p *SocityServiceClient) CommentAction(ctx context.Context, req *CommentActionRequest) (r *CommentActionResponse, err error) {
	var _args SocityServiceCommentActionArgs
	_args.Req = req
	var _result SocityServiceCommentActionResult
	if err = p.Client_().Call(ctx, "CommentAction", &_args, &_result); err != nil {
		return
	}
	return _result.GetSuccess(), nil
}
func (p *SocityServiceClient) CommentList(ctx context.Context, req *CommentListRequest) (r *CommentListResponse, err error) {
	var _args SocityServiceCommentListArgs
	_args.Req = req
	var _result SocityServiceCommentListResult
...
type SocityServiceProcessor struct {
	processorMap map[string]thrift.TProcessorFunction
	handler      SocityService
}

func (p *SocityServiceProcessor) AddToProcessorMap(key string, processor thrift.TProcessorFunction) {
	p.processorMap[key] = processor
}

func (p *SocityServiceProcessor) GetProcessorFunction(key string) (processor thrift.TProcessorFunction, ok bool) {
	processor, ok = p.processorMap[key]
	return processor, ok
}

func (p *SocityServiceProcessor) ProcessorMap() map[string]thrift.TProcessorFunction {
	return p.processorMap
}

func NewSocityServiceProcessor(handler SocityService) *SocityServiceProcessor {
	self := &SocityServiceProcessor{handler: handler, processorMap: make(map[string]thrift.TProcessorFunction)}
	self.AddToProcessorMap("FavoriteAction", &socityServiceProcessorFavoriteAction{handler: handler})
	self.AddToProcessorMap("CommentAction", &socityServiceProcessorCommentAction{handler: handler})
	self.AddToProcessorMap("CommentList", &socityServiceProcessorCommentList{handler: handler})
	return self
}
func (p *SocityServiceProcessor) Process(ctx context.Context, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
...
type socityServiceProcessorFavoriteAction struct {
	handler SocityService
}

func (p *socityServiceProcessorFavoriteAction) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	args := SocityServiceFavoriteActionArgs{}
	...
	iprot.ReadMessageEnd()
	var err2 error
	result := SocityServiceFavoriteActionResult{}
...
type socityServiceProcessorCommentAction struct {
	handler SocityService
}

func (p *socityServiceProcessorCommentAction) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	args := SocityServiceCommentActionArgs{}
	if err = args.Read(iprot); err != nil {
		iprot.ReadMessageEnd()
		x := thrift.NewTApplicationException(thrift.PROTOCOL_ERROR, err.Error())
	...
	iprot.ReadMessageEnd()
	var err2 error
	result := SocityServiceCommentActionResult{}
...
type socityServiceProcessorCommentList struct {
	handler SocityService
}

func (p *socityServiceProcessorCommentList) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	args := SocityServiceCommentListArgs{}
	if err = args.Read(iprot); err != nil {
		iprot.ReadMessageEnd()
		x := thrift.NewTApplicationException(thrift.PROTOCOL_ERROR, err.Error())
	...
	iprot.ReadMessageEnd()
	var err2 error
	result := SocityServiceCommentListResult{}
...
type SocityServiceFavoriteActionArgs struct {
	Req *FavoriteActionRequest `thrift:"req,1" frugal:"1,default,FavoriteActionRequest" json:"req"`
}

func NewSocityServiceFavoriteActionArgs() *SocityServiceFavoriteActionArgs {
	return &SocityServiceFavoriteActionArgs{}
}

func (p *SocityServiceFavoriteActionArgs) InitDefault() {
	*p = SocityServiceFavoriteActionArgs{}
}

var SocityServiceFavoriteActionArgs_Req_DEFAULT *FavoriteActionRequest

func (p *SocityServiceFavoriteActionArgs) GetReq() (v *FavoriteActionRequest) {
	if !p.IsSetReq() {
		return SocityServiceFavoriteActionArgs_Req_DEFAULT
	}
	return p.Req
}
func (p *SocityServiceFavoriteActionArgs) SetReq(val *FavoriteActionRequest) {
	p.Req = val
}

var fieldIDToName_SocityServiceFavoriteActionArgs = map[int16]string{
	1: "req",
}

func (p *SocityServiceFavoriteActionArgs) IsSetReq() bool {
	return p.Req != nil
}

func (p *SocityServiceFavoriteActionArgs) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_SocityServiceFavoriteActionArgs[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *SocityServiceFavoriteActionArgs) ReadField1(iprot thrift.TProtocol) error {
...
func (p *SocityServiceFavoriteActionArgs) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
...
func (p *SocityServiceFavoriteActionArgs) writeField1(oprot thrift.TProtocol) (err error) {
...
func (p *SocityServiceFavoriteActionArgs) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("SocityServiceFavoriteActionArgs(%+v)", *p)
}

func (p *SocityServiceFavoriteActionArgs) DeepEqual(ano *SocityServiceFavoriteActionArgs) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
...
func (p *SocityServiceFavoriteActionArgs) Field1DeepEqual(src *FavoriteActionRequest) bool {
...
type SocityServiceFavoriteActionResult struct {
	Success *FavoriteActionResponse `thrift:"success,0,optional" frugal:"0,optional,FavoriteActionResponse" json:"success,omitempty"`
}

func NewSocityServiceFavoriteActionResult() *SocityServiceFavoriteActionResult {
	return &SocityServiceFavoriteActionResult{}
}

func (p *SocityServiceFavoriteActionResult) InitDefault() {
	*p = SocityServiceFavoriteActionResult{}
}

var SocityServiceFavoriteActionResult_Success_DEFAULT *FavoriteActionResponse

func (p *SocityServiceFavoriteActionResult) GetSuccess() (v *FavoriteActionResponse) {
	if !p.IsSetSuccess() {
		return SocityServiceFavoriteActionResult_Success_DEFAULT
	}
	return p.Success
}
func (p *SocityServiceFavoriteActionResult) SetSuccess(x interface{}) {
	p.Success = x.(*FavoriteActionResponse)
}

var fieldIDToName_SocityServiceFavoriteActionResult = map[int16]string{
	0: "success",
}

func (p *SocityServiceFavoriteActionResult) IsSetSuccess() bool {
	return p.Success != nil
}

func (p *SocityServiceFavoriteActionResult) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_SocityServiceFavoriteActionResult[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *SocityServiceFavoriteActionResult) ReadField0(iprot thrift.TProtocol) error {
...
func (p *SocityServiceFavoriteActionResult) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
...
func (p *SocityServiceFavoriteActionResult) writeField0(oprot thrift.TProtocol) (err error) {
	if p.IsSetSuccess() {
...
func (p *SocityServiceFavoriteActionResult) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("SocityServiceFavoriteActionResult(%+v)", *p)
}

func (p *SocityServiceFavoriteActionResult) DeepEqual(ano *SocityServiceFavoriteActionResult) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
...
func (p *SocityServiceFavoriteActionResult) Field0DeepEqual(src *FavoriteActionResponse) bool {
...
type SocityServiceCommentActionArgs struct {
	Req *CommentActionRequest `thrift:"req,1" frugal:"1,default,CommentActionRequest" json:"req"`
}

func NewSocityServiceCommentActionArgs() *SocityServiceCommentActionArgs {
	return &SocityServiceCommentActionArgs{}
}

func (p *SocityServiceCommentActionArgs) InitDefault() {
	*p = SocityServiceCommentActionArgs{}
}

var SocityServiceCommentActionArgs_Req_DEFAULT *CommentActionRequest

func (p *SocityServiceCommentActionArgs) GetReq() (v *CommentActionRequest) {
	if !p.IsSetReq() {
		return SocityServiceCommentActionArgs_Req_DEFAULT
	}
	return p.Req
}
func (p *SocityServiceCommentActionArgs) SetReq(val *CommentActionRequest) {
	p.Req = val
}

var fieldIDToName_SocityServiceCommentActionArgs = map[int16]string{
	1: "req",
}

func (p *SocityServiceCommentActionArgs) IsSetReq() bool {
	return p.Req != nil
}

func (p *SocityServiceCommentActionArgs) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_SocityServiceCommentActionArgs[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *SocityServiceCommentActionArgs) ReadField1(iprot thrift.TProtocol) error {
...
func (p *SocityServiceCommentActionArgs) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
...
func (p *SocityServiceCommentActionArgs) writeField1(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("req", thrift.STRUCT, 1); err != nil {
		goto WriteFieldBeginError
	}
	if err := p.Req.Write(oprot); err != nil {
...
func (p *SocityServiceCommentActionArgs) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("SocityServiceCommentActionArgs(%+v)", *p)
}

func (p *SocityServiceCommentActionArgs) DeepEqual(ano *SocityServiceCommentActionArgs) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
...
func (p *SocityServiceCommentActionArgs) Field1DeepEqual(src *CommentActionRequest) bool {
...
type SocityServiceCommentActionResult struct {
	Success *CommentActionResponse `thrift:"success,0,optional" frugal:"0,optional,CommentActionResponse" json:"success,omitempty"`
}

func NewSocityServiceCommentActionResult() *SocityServiceCommentActionResult {
	return &SocityServiceCommentActionResult{}
}

func (p *SocityServiceCommentActionResult) InitDefault() {
	*p = SocityServiceCommentActionResult{}
}

var SocityServiceCommentActionResult_Success_DEFAULT *CommentActionResponse

func (p *SocityServiceCommentActionResult) GetSuccess() (v *CommentActionResponse) {
	if !p.IsSetSuccess() {
		return SocityServiceCommentActionResult_Success_DEFAULT
	}
	return p.Success
}
func (p *SocityServiceCommentActionResult) SetSuccess(x interface{}) {
	p.Success = x.(*CommentActionResponse)
}

var fieldIDToName_SocityServiceCommentActionResult = map[int16]string{
	0: "success",
}

func (p *SocityServiceCommentActionResult) IsSetSuccess() bool {
	return p.Success != nil
}

func (p *SocityServiceCommentActionResult) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_SocityServiceCommentActionResult[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *SocityServiceCommentActionResult) ReadField0(iprot thrift.TProtocol) error {
...
func (p *SocityServiceCommentActionResult) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
...
func (p *SocityServiceCommentActionResult) writeField0(oprot thrift.TProtocol) (err error) {
	if p.IsSetSuccess() {
		if err = oprot.WriteFieldBegin("success", thrift.STRUCT, 0); err != nil {
			goto WriteFieldBeginError
		}
...
func (p *SocityServiceCommentActionResult) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("SocityServiceCommentActionResult(%+v)", *p)
}

func (p *SocityServiceCommentActionResult) DeepEqual(ano *SocityServiceCommentActionResult) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
...
func (p *SocityServiceCommentActionResult) Field0DeepEqual(src *CommentActionResponse) bool {
...
type SocityServiceCommentListArgs struct {
	Req *CommentListRequest `thrift:"req,1" frugal:"1,default,CommentListRequest" json:"req"`
}

func NewSocityServiceCommentListArgs() *SocityServiceCommentListArgs {
	return &SocityServiceCommentListArgs{}
}

func (p *SocityServiceCommentListArgs) InitDefault() {
	*p = SocityServiceCommentListArgs{}
}

var SocityServiceCommentListArgs_Req_DEFAULT *CommentListRequest

func (p *SocityServiceCommentListArgs) GetReq() (v *CommentListRequest) {
	if !p.IsSetReq() {
		return SocityServiceCommentListArgs_Req_DEFAULT
	}
	return p.Req
}
func (p *SocityServiceCommentListArgs) SetReq(val *CommentListRequest) {
	p.Req = val
}

var fieldIDToName_SocityServiceCommentListArgs = map[int16]string{
	1: "req",
}

func (p *SocityServiceCommentListArgs) IsSetReq() bool {
	return p.Req != nil
}

func (p *SocityServiceCommentListArgs) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_SocityServiceCommentListArgs[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *SocityServiceCommentListArgs) ReadField1(iprot thrift.TProtocol) error {
...
func (p *SocityServiceCommentListArgs) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
...
func (p *SocityServiceCommentListArgs) writeField1(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("req", thrift.STRUCT, 1); err != nil {
		goto WriteFieldBeginError
	}
	if err := p.Req.Write(oprot); err != nil {
...
func (p *SocityServiceCommentListArgs) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("SocityServiceCommentListArgs(%+v)", *p)
}

func (p *SocityServiceCommentListArgs) DeepEqual(ano *SocityServiceCommentListArgs) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
...
func (p *SocityServiceCommentListArgs) Field1DeepEqual(src *CommentListRequest) bool {
...
type SocityServiceCommentListResult struct {
	Success *CommentListResponse `thrift:"success,0,optional" frugal:"0,optional,CommentListResponse" json:"success,omitempty"`
}

func NewSocityServiceCommentListResult() *SocityServiceCommentListResult {
	return &SocityServiceCommentListResult{}
}

func (p *SocityServiceCommentListResult) InitDefault() {
	*p = SocityServiceCommentListResult{}
}

var SocityServiceCommentListResult_Success_DEFAULT *CommentListResponse

func (p *SocityServiceCommentListResult) GetSuccess() (v *CommentListResponse) {
	if !p.IsSetSuccess() {
		return SocityServiceCommentListResult_Success_DEFAULT
	}
	return p.Success
}
func (p *SocityServiceCommentListResult) SetSuccess(x interface{}) {
	p.Success = x.(*CommentListResponse)
}

var fieldIDToName_SocityServiceCommentListResult = map[int16]string{
	0: "success",
}

func (p *SocityServiceCommentListResult) IsSetSuccess() bool {
	return p.Success != nil
}

func (p *SocityServiceCommentListResult) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_SocityServiceCommentListResult[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *SocityServiceCommentListResult) ReadField0(iprot thrift.TProtocol) error {
...
func (p *SocityServiceCommentListResult) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
...
func (p *SocityServiceCommentListResult) writeField0(oprot thrift.TProtocol) (err error) {
	if p.IsSetSuccess() {
		if err = oprot.WriteFieldBegin("success", thrift.STRUCT, 0); err != nil {
			goto WriteFieldBeginError
		}
...
func (p *SocityServiceCommentListResult) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("SocityServiceCommentListResult(%+v)", *p)
}

func (p *SocityServiceCommentListResult) DeepEqual(ano *SocityServiceCommentListResult) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
...
func (p *SocityServiceCommentListResult) Field0DeepEqual(src *CommentListResponse) bool {
